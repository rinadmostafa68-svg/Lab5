...
public class HomePage extends javax.swing.JFrame {
    ...
    public HomePage(Login parent) throws FileNotFoundException {
        initComponents();
        this.db = new AdminOperations("students.txt");
        this.parent = parent;
    }
    ...
    private void AddStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddStudentActionPerformed
        ...
        AddStudent x = new AddStudent(db, this);
        x.setVisible(true);
    ...
    private void ViewStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewStudentActionPerformed
        // TODO add your handling code here:
        ViewStudents view = new ViewStudents(db, this);
